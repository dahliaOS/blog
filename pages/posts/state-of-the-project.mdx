...
![zenit_ui demo](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image6.png?raw=true)

Official support for RISCV devices,

![neofetch and dart running on a RISCV build of dahliaOS](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image5.png?raw=true)

Lots of interface design work,

![App Store concept design](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image4.png?raw=true)

![New settings app concept](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image1.png?raw=true)

Improvements to our Terminal and Files applications,

![Files App improvements](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image8.png?raw=true)

![Terminal app running on macOS](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image7.png?raw=true)

…an actual compositor,

![Pangolin compositor with gnome-calculator and KWrite](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image3.png?raw=true)

![Compositor with keyboard input being demonstrated](https://github.com/dahliaOS/blog/blob/main/pages/posts/state-of-the-project/images/image2.png?raw=true)
